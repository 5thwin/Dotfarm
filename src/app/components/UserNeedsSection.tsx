...
export default function UserNeedsSection() {
  return <section className='w-full flexCenter my-16'>
...
// style
const titleContainer = clsx('text-2xl text-center', 'lg:text-left lg:text-3xl lg:leading-normal')
const farmerWrapper = clsx('flexCenter flex-col gap-y-5', 'lg:flex-row lg:gap-x-5')
