...
export default function Footer() {
	return (
		<footer className="w-screen h-[190px] bg-white relative border-t border-subGray">
			<div className="flex items-center justify-between gap-x-[60px] absolute left-[100px] right-[100px] top-1/2 -translate-y-1/2">
				<div className="flex gap-x-[60px]">
					<div className="flex flex-col gap-y-30px">
						...
						<div className="flex flex-col gap-y-5px">
							<p className="text-lg font-semibold">제휴 및 광고 문의</p>
				...
				<div className="flex gap-x-2.5">
					<PrivacyButton className="font-bold text-lg" />
					<TermButton className="font-bold text-lg" />
				</div>
			</div>
		</footer>
	);
