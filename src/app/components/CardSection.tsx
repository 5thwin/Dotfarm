      ...
      <div id='card_1' className={clsx(cardStyle, 'bg-[#DFF7FF]')}>
        <div className='relative'>
          <Image
            ...
            height={208}
          />
          <div className={blurBoxStyle} style={{ background: 'linear-gradient(0deg, #DFF7FF 0%, rgba(223, 247, 255, 0.00) 100%)' }}></div>
        </div>
        <div className={cardTextContainerStyle}>
          <p className={cardTitleStyle}>
            {cardText.card1.title}
          </p>
      ...
      <div id='card_2' className={clsx(cardStyle, 'bg-[#E9FFDC]')}>
        <div className='relative'>
          <Image
            ...
            height={208}
          />
          <div className={blurBoxStyle} style={{ background: 'linear-gradient(0deg, #E9FFDC 0%, rgba(223, 247, 255, 0.00) 100%)' }}></div>
        </div>
        <div className={cardTextContainerStyle}>
          <p className={cardTitleStyle}>
            {cardText.card2.title}
          </p>
          <p className={cardDescriptionStyle}>
      ...
      <div id='card_3' className={clsx(cardStyle, 'bg-[#FFEFDC]')}>
        <div className='relative'>
          <Image
            ...
            height={208}
          />
          <div className={blurBoxStyle} style={{ background: 'linear-gradient(0deg, #FFEFDC 0%, rgba(223, 247, 255, 0.00) 100%)' }}></div>
        </div>
        <div className={cardTextContainerStyle}>
          <p className={cardTitleStyle}>
            {cardText.card3.title}
          </p>
          <p className={cardDescriptionStyle}>
...
const cardText = {
  card1: {
    title: "농업관련 지원사업",
    description: "각종 지역별 지자체와 농업 관련 기관들의 데이터를 수집한 지원 사업들을 제공합니다.",
    button: "지원사업 보기 >"
  },
  card2: {
    title: "뉴스레터",
    description: "기관에서 보여주기식 뉴스를 제외하고 최근 농업 관련 뉴스 근황 뉴스를 제공합니다",
    button: "뉴스레터 보기 >"
  },
  card3: {
    title: "영상레터",
    description: "영상 채널에서 유용한 정보를 모아 주마다 업로드하여 쉽고 빠르게 보실 수 있습니다",
    button: "영상레터 보기 >"
  },
}

// style
const cardStyle = clsx('w-[307px] h-[432px] flexCenter flex-col gap-y-6', 'rounded-40', 'px-7 py-6')
const cardButtonStyle = clsx('py-5 px-10 flexCenter', 'rounded-full bg-white shadow-main', 'font-bold')
