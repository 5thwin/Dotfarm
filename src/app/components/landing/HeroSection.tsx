...
export default function HeroSection() {
	return (
		<section
			className="flexCenter flex-col py-24 w-full lg:min-h-screen "
			style={{
				background:
					'linear-gradient(180deg, #C1FFCF 0%, rgba(255, 255, 255, 0.00) 100%)',
			}}
		>
...
const mainTitleContainer = clsx(
	'text-2xl text-center',
	'lg:text-left lg:text-[45px] lg:leading-normal'
);
const subTextStyle = clsx(
	'text-center text-details',
	'lg:text-left lg:text-[28px] lg:leading-normal'
);
